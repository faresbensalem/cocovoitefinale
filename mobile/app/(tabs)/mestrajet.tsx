...
const styles = StyleSheet.create({
  ...
  secondaryButton: { flexDirection: 'row',   marginTop: 80, alignItems: 'center', gap: 6, backgroundColor: '#F3F4F6', paddingHorizontal: 10, paddingVertical: 8, borderRadius: 10 },
  ...
  primaryButton: { marginTop: 10, backgroundColor: '#007AFF', paddingVertical: 12, paddingHorizontal: 16, borderRadius: 10, alignItems: 'center' },
